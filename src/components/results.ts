...
const results: { [id: number]: result } = {
  ...
  2: {
    ...
    info: `머야머야 옷이 그게 머야-!!
    그런 당신을 위해 준비한 부기온앤온 금가루 뿌린 화과자가 여기있단 말씀!
  ...
  4: {
    ...
    여행가는 날은 날씨가 화창할거란 말씀! 헤헤 효과없으면 어떡하냐고?
  ...
  5: {
    ...
    잠시만... 나더러 흑기사 해달라구? 싫어 나는 흑기사가 아니라 흑끼걸랑 ㅋ`,
  },
  6: {
    name: '엿처럼 한방에 붙는 찹쌀떡',
    ...
    *삐리삐리샤라쁑쁑 엿먹어라 내 찹쌀같은 인생아@@@! 힝 실은 뻥임 ㅅㄱ`,
  },
  7: {
  ...
  8: {
    ...
    이거 먹고 인간이 돼서 어려운 사람도 많이 도와주고, 훌륭한 인품 갖추길 응원할게
  ...
  10: {
    ...
    너의 평생 우정이 계속되면 좋겠어 ><
    세상에 꺾일 때면~ 술 한 잔 기울이며~ 이제는 우리의 날들이 온다고~!!`,
  },
  11: {
    name: '가족끼리 먹는 떡국',
  ...
  12: {
    ...
    info: `Hey! 자네!! 낭만을 꿈꾸며 현실을 살아가고 있지 않은가?
    그렇다면 너에게는 몽글몽글한 구름떡이 딱이라구!
    이 떡을 먹으면 너도 현실적인 잇속도 챙기고 낭만적인 꿈도 이룰 수 있을 거얌!
    이거 먹고 새해에는 반복되는 일상에서 낭만을 찾을 수 있기를 응원행 ㅎㅎ
  ...
  13: {
    ...
    어쩌면 승진도 하구 인맥도 늘어날지도?! 히히 안 먹구 뭐해?
    언제까지 어깨춤을 추게할거양~ 내 어깨를 봐~ 탈골됐잖아`,
  },
  14: {
    name: '고생끝에 낙이 오리라 솔방울떡',
    img: require('../static/images/result/14.png'),
    info: `이봐! 자네! 고생 끝에 낙이 온다는 말을 알고있는가?
    이 솔방울떡을 먹으면 그 말의 의미를 알게 될거라구.. 후후
    이 떡을 먹으면 네가 목표한 일은 물론 더 큰 복이 뒤따를수도 있다구!!
  ...
  15: {
    ...
    info: `이 떡을 로맨틱한 너의 눈동자에 빠뜨리고 싶어...! 으앙 어쩜 좋니 ㅎㅎ
  ...
  16: {
    ...
    이 바삭쫄깃하고 예쁘기까지한 화전을 먹으면 꽃같은 결실을 맺을 수 있을 거야
    인내...! 그것은 나 자신과의 약속! 청춘은 약속의 시기라구!
    외쳐보자 우리! 청바지! 청춘은 바로 지금! 인내의 땀이 묻은 아름다운 청바지!@@@`,
  },
  17: {
    name: '무한한 가능성을 지닌 가래떡',
    img: require('../static/images/result/17.png'),
    info: `아이참~ 기다료바~  너의 젊음을 불려서
    가래떡을 쭉쭉 뽑고 있는 중이니까!
    이 떡을 먹으면 오래 지속되는 관계와 인내심을 얻을 수 있다구!
    이 긴 가래떡처럼 주변 사람들과
    오래오래 행복하게 지내면서 너를 위한 결실도 맺어보자구!
    아 가래떡 먹고 침 뱉으면 가래침이니까 침 뱉으면 안 된다규 ㅎㅎ 알겠징? ><`,
  },
  ...
  18: {
    ...
    여러가지 열심히 하느라 지치지 말구 차근차근 이뤄가길 바랄겡 ㅎㅎ
  ...
  20: {
    ...
    즐겁고 낭만적인 삶을 살 수 있다구!
    새해에는 여행도 가고 이색취미도 가져보고 새 사람이 되어보는 건 어떠니?
    잉? 나도 백설기처럼 백토끼하라구?
    시른뎅? 시른뎅? 킹받쥬? 못때리쥬 ㅋㅋ`,
  },
  21: {
  ...
  22: {
    ...
    그런 너를 위해 준비한 떡케이크!!
    이걸 먹으면 너는 강인한 정신을 얻고 어떤 난관에도 불구하고 목표한 걸 이뤄낼거얌!
    말하자면 요런거징!
